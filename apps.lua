...
apps.heroic = function()
	helpers.run_or_raise({ class = "Heroic" }, false, "heroic")
end
...
apps.passwords = function()
	helpers.run_or_raise({ class = "Bitwarden" }, true, "bitwarden")
end
...
apps.org = function()
	helpers.run_or_raise(
		{ instance = "emacs" },
		false,
		user.terminal .. " --class editor -e emacsclient --nw -t -s doom ~/Documents/Org/Agenda/Agenda.org",
		{ switchtotag = true }
	)
end
apps.music = function()
