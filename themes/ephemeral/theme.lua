...
theme.titlebar_font = "sans bold 8"
...
theme.taglist_text_color_empty = { x.foreground .. "60", x.foreground .. "60", x.foreground .. "60", x.foreground .. "60",
    x.foreground .. "60", x.foreground .. "60", x.foreground .. "60", x.foreground .. "60", x.foreground .. "60",
    x.foreground .. "60" }
...
theme.taglist_text_color_occupied = { x.color1, x.color2, x.color3, x.color4, x.color5, x.color6, x.color1, x.color2,
    x.color3, x.color4 }
theme.taglist_text_color_focused  = { x.color1, x.color2, x.color3, x.color4, x.color5, x.color6, x.color1, x.color2,
    x.color3, x.color4 }
theme.taglist_text_color_urgent   = { x.color7, x.color7, x.color7, x.color7, x.color7, x.color7, x.color7, x.color7,
    x.color7, x.color7 }
